...
Sandbox.prototype = import$(Object.create(Object.prototype), {
  ...
  load: function(payload){
    ...
    return new Promise(function(res, rej){
      var url;
      this$.url = url = URL.createObjectURL(new Blob([payload + this$.rpcCode], {
        type: 'text/html'
      }));
      this$.root.onload = function(){
        return res(url);
  ...
  loadUrl: function(d){
    ...
    promises = ['html', 'css', 'js'].map(function(it){
      ...
      return fetch(n[1]).then(function(v){
        if (!(v && v.ok)) {
    ...
    return Promise.all(promises).then(function(list){
      ...
      list.map(function(it){
        return payload[it[0]] = it[1];
      });
      return this$.loadHcj(payload);
    });
  },
  loadHcj: function(d){
...
sb.loadUrl({
  ...
  return new Promise(function(res, rej){
    return setTimeout(function(){
      ...
      return sb.loadHcj(config).then(function(){
        return res();
      });
    }, 0);
  });
